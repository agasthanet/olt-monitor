...
### Fixed
- Error 500 saat simpan registrasi (`NameError: re` di validasi WhatsApp)

## [1.11.4] — 2026-09-23

### Changed
- Registrasi wajib: **nama, perusahaan, email, no. WhatsApp**
- UI tidak menyebut pembagian data / telemetry
